package com.hopegaming.common.widget.tablayout;

/**
 * Created by fangzheng on 08/20/2019
 */
/*
 ...
 *
 *  Notice: 2019-11-08 改动的地方 by fangzheng
 */
...
import com.hopegaming.common.R;
...
public class CustomTabLayout extends HorizontalScrollView {
  ...
  /**
   * Gravity used to fill the {@link CustomTabLayout} as much as possible. This option only takes effect
  ...
  /**
   * Gravity used to lay out the tabs in the center of the {@link CustomTabLayout}.
   *
   * @see #setTabGravity(int)
   * @see #getTabGravity()
   */
  ...
  public CustomTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    super.addView(mTabStrip, 0, new HorizontalScrollView.LayoutParams(LayoutParams.WRAP_CONTENT,
  ...
  /**
   * Add a {@link CustomTabLayout.OnTabSelectedListener} that will be invoked when tab selection
   * changes.
   *
  ...
  /**
   * Remove the given {@link CustomTabLayout.OnTabSelectedListener} that was previously added via
  ...
  /**
   * Remove all previously added {@link CustomTabLayout.OnTabSelectedListener}s.
   */
  ...
  /**
   * Returns the current mode used by this {@link CustomTabLayout}.
   *
   * @see #setTabMode(int)
   */
  @Mode
  ...
  /**
   * The one-stop shop for setting up this {@link CustomTabLayout} with a {@link ViewPager}.
   *
  ...
  class TabView extends LinearLayout {
    ...
    public TabView(Context context) {
      ...
      if (mTabBackgroundResId != 0) {
        ViewCompat.setBackground(this,
            AppCompatResources.getDrawable(context, mTabBackgroundResId));
      }
    ...
    final void update() {
      ...
      if (mCustomView == null) {
        ...
        if (mIconView == null) {
          ImageView iconView = (ImageView) LayoutInflater
              .from(getContext())
  ...
  private class SlidingTabStrip extends LinearLayout {
    ...
    private void updateIndicatorPosition() {
      ...
      // Notice: 2019-11-08 改动的地方,获取tab title文字的长度
      // 此处改动的,应付场景是:用tabLayout以及viewPager
      TabView tabView = (TabView) selectedTitle;
      int txtWidth = 0;
      if (tabView != null) {
        txtWidth = tabView.mTextView.getMeasuredWidth();
      }
      ...
      int temp = (right - left - txtWidth) / 2;
      setIndicatorPosition(left + temp, right - temp);
    }
    ...
    void animateIndicatorToPosition(final int position, int duration) {
      ...
      // Notice: 2019-11-08 改动的地方,获取tab title文字的长度
      // 此处改动的,应付场景是:用tabLayout手动设置customView
      TabView tabView = (TabView) targetView;
      int txtWidth = tabView.mTextView.getMeasuredWidth();
      int targetLeft_x = targetView.getLeft();
      int targetRight_x = targetView.getRight();
      int temp = (targetRight_x - targetLeft_x - txtWidth) / 2;
      final int targetLeft = targetLeft_x + temp;
      final int targetRight = targetRight_x - temp;
      ...
      if (startLeft != targetLeft || startRight != targetRight) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
          ...
          public void onAnimationUpdate(ValueAnimator animator) {
            ...
            setIndicatorPosition(AnimationUtils.lerp(startLeft, targetLeft, fraction),
    ...
    public void draw(Canvas canvas) {
      ...
      if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
        canvas.drawRect(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight, mIndicatorRight,
   ...
   * necessary calls back to the provided {@link CustomTabLayout} so that the tab position is
   * kept in sync.
   *
  ...
  public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
    ...
    public void onPageScrolled(final int position, final float positionOffset,
      ...
      final CustomTabLayout customTabLayout = mTabLayoutRef.get();
    ...
    public void onPageSelected(final int position) {
      final CustomTabLayout customTabLayout = mTabLayoutRef.get();
      if (customTabLayout != null && customTabLayout.getSelectedTabPosition() != position &&
          position < customTabLayout.getTabCount()) {
  ...
  /**
   * A {@link CustomTabLayout.OnTabSelectedListener} class which contains the necessary calls back
  ...
  public static class ViewPagerOnTabSelectedListener implements
      CustomTabLayout.OnTabSelectedListener {
